...
declare module "react-native-star-prnt" {
    ...
    export interface PrintCommand {
         ...
         * 'UK' | 'USA' | 'France' | 'Germany' | 'Denmark' | 'Sweden' | 'Italy' | 'Spain' | 'Japan' | 'Norway' |
         * 'Denmark2' | 'Spain2' | 'LatinAmerica' | 'Korea' | 'Ireland' | 'Legal'
        ...
        /**
         * Absolute position command is generated and added to the command buffer. (Unit: Dots). Send in conjunction with
         * the data property to append absolute position just to that string
         ...
         * Example with absolutePosition: {appendBarcode:"{BStar", BarcodeSymbology:BarcodeSymbology.Code128, BarcodeWidth:BarcodeWidth.Mode2,
         * height:40, hri:true, absolutePosition:40 }
         * Example with alignment:{appendBarcode:"{BStar", BarcodeSymbology:BarcodeSymbology.Code128, BarcodeWidth:BarcodeWidth.Mode2, height:40,
         * hri:true, alignment:alignment:AlignmentPosition.Center }
         */
    ...
    export const StarPRNT = {
        portDiscovery: (port: string) => Promise<Printer[]>(),
        print: (emulation: string | undefined, commands: PrintCommand[], portName: string) => Promise<string>(),
        CutPaperAction,
        AlignmentPosition
    }
}
