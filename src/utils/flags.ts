...
export default {
  ...
  "zz": require("../../assets/images/flags/zz.png"),
  "es-pv": require("../../assets/images/flags/es-pv.png"),
  "es-gl": require("../../assets/images/flags/es-gl.png"),
  "es-ca": require("../../assets/images/flags/es-ca.png")
} as Flags
